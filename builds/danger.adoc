...
Clang and SourceKit to parse your source files and check them against a
set of rules that you can fully customize.
...
coverage in your projects and **fails the build** if the percentage fall
below the value for `minimum_coverage_percentage` (30% in this case):
