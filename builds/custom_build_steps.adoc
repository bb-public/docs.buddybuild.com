...
link:https://github.com/realm/SwiftLint[Swiftlint] is a tool to enforce Swift
style and conventions. You can install it manually from a custom build step:
...
you will need either a `buddybuild_postclone.sh` file or
a `buddybuild_prebuild.sh` one.
For more information, see link:https://github.com/realm/SwiftLint[the
