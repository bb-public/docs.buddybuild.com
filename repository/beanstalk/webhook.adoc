---
titletext: Add a Beanstalk Webhook to automate your mobile CI process
description: >
  Use Beanstalk Webhooks to notify buddybuild of repository code changes so that we can
  kick off new builds, update build statuses, and notify testers.
---
