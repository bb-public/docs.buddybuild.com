--- 
titletext: Adding a Gitolite Webhook to your mobile CI process
description: >
  Use Gitolite Webhooks to notify buddybuild of repo code changes so we can kick
  off new builds, update build statuses and notify testers of latest builds.
---
