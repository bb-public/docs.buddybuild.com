...
image:img/paste-clone-url.png["The buddybuild git clone screen",
1500, 765]
...
image:img/copy-ssh-key.png["The buddybuild git clone screen, with
the SSH key selected", 1500, 765]
...
image:img/build.png["The buddybuild git clone screen", 3000, 800]
