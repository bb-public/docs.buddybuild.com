...
[TIP]
=====
We try to automate everything, from discovering your app's dependencies
and build configuration, to providing a smooth deployment to your app's
testers and on to your favorite application store. Setup typically takes
just a few minutes.

We also make collecting feedback from your testers easy and intuitive,
so you get targeted feedback as you iterate on your app.
=====
