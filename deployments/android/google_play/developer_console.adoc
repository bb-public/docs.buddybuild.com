--- 
titletext: Create a Google Play serivce account development account
description: >
  Buddybuild integrated with Google Play to autodeploy your Android apps.  You
  must first create a service account and set up the proper permisissions.
---
