...
. FIXME: add a screenshot here
  If you _do_ have an existing HipChat connection, click the ... and
  then the ...
--
+
...
. image:img/button....
  Click the ** FIXME ** button. The **Connection confirmation** screen
  is displayed:
+
...
+
image:img/screen-hipchat... FIXME!

FIXME: Slack image filenames, jumps to Slack channel selection.
