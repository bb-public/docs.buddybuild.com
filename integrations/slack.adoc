...
description: >
  Buddybuild offers first-class integration with Slack, providing notifications
  for build status, feedback submissions, and crash reports directly to channels
---
= Slack
