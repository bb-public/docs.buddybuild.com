...
description: >
  Buddybuild integration settings for the Apple Developer Portal,
  HipChat, Jira, Pivotal Tracker, and Slack can be set in one place and
  applied to all apps.
---
...
- link:{{readme.path}}/deployments/itunes_connect.adoc[Upload
