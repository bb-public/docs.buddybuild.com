...
image:img/Settings---Apple-Developer---credentials.png[,3000,1600]
...
Buddybuild will validate your account and might ask you to select a team
if you're part of multiple.
