--- 
titletext: How to add unit tests to Android Continuous Integration
description: >
  Buddybuild has out of the box support for Android unit tests.  Unit Tests will
  be automatically run and you can view the results in buddybuild.
---
= Testing
