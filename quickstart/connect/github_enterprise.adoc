...
link:{{readme.path}}/repository/self_hosted.adoc[Self-hosted
...
instance is already configured! screen", 1280, 531, role="frame"]
+
...
screen in GitHub Enterprise", 1280, 482, role="frame"]
...
OAuth app in GitHub Enterprise", 1280, 550, role="frame"]
