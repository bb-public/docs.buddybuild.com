...
TestFlight builds deployed with buddybuild have all the buddybuild SDK
features that were enabled. If you don't want your TestFlight
deployments to have these features, you will have to turn them off in
settings in the dashboard and submit a new build to TestFlight.
======
