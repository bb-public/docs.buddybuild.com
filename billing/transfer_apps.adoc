...
description: >
  You can transfer an app from one organization to another. When you transfer an app to
  another organization, it adopts the features and limitations of the new organization's plan.
---
